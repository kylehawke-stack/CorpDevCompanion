...
**THEMES (100-150 words):** Identify 2-3 key themes revealed by the team's voting patterns. What strategic directions does the team gravitate toward? Reference specific financial data — e.g., "Given the company's [$X] in available cash and [$Y] in unused credit facilities, the team's preference for [theme] suggests an appetite for deals in the [$range] range."
...
- Never mention "AI", "algorithmic", "machine learning", or how ideas were sourced.
...
Tone: Professional, board-ready. Direct and analytical. No hedging or filler.
